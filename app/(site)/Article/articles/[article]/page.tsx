...
const components: PortableTextComponents = {
  ...
  block: {
    ...
    h3: ({ children }) => (
      <h3 className="text-xl text-center font-semibold text-center mt-3 mb-3">{children}</h3>
    ),
    h4: ({ children }) => (
      <h4 className="text-lg text-center font-medium text-center mt-2 mb-3">{children}</h4>
    ),
    h5: ({ children }) => (
      <h5 className="text-base text-center font-medium text-center mt-2 mb-3">{children}</h5>
    ),
    h6: ({ children }) => (
            ...
            <main className="text-center opacity-100">
                ...
                {article.image && (
                    <div className="flex justify-center items-center mt-8">
                        ...
                        />
                          <div>
                            <figcaption className="text-sm text-gray-500 mt-2 italic text-center w-full">{article.imageCaption}</figcaption>
                          </div>
                        </div>
                    </div>
                )}
