import { getHistories} from '@/sanity/sanity-utils';
        ...
        <header className="flex justify-between items-center px-[100px] py-[20px] bg-[#f8f8f6]">
            ...
            <nav className="flex items-center shadow-none ">
                <ul className="flex gap-[40px] list-none m-0 p-0">
                    ...
                    <li>
                        <a href="/History" className="text-[#777] text-[16px] relative transition-colors duration-300 hover:text-[#252424] after:content-[''] after:absolute after:left-0 after:bottom-[-3px] after:w-full after:h-[2px] after:bg-[#252424] after:transition-all after:duration-300 hover:after:w-full">
                            Climate Histories
                        </a>
                    </li>
                    <li>
...
// Sort by date (newest first)
            ...
            >
                <Link href={`/History/histories/${history.slug}`}>
